...
export function LegalLayout({ kicker = "CampusFind", title, updated, children }: LegalLayoutProps) {
  return (
    <article className="container max-w-2xl py-16 md:py-24">
      <p className="text-[12px] font-medium uppercase tracking-[0.18em] text-muted-foreground">{kicker}</p>
